...
The current renderer endpoint is `PHASE4A3_DATE_AND_TIME_FONT_REPORT.md`, following the Phase 3.1
cleanup and physical-display refinement work. Earlier reports document how the corpus progressed
through normalization, public-domain mining, clock-face eligibility, and sparse-tail recovery.
...
`PHASE4A3_DATE_AND_TIME_FONT_REPORT.md`, and `RENDER_QA.md` for current renderer status.
