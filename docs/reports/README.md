...
The current renderer endpoint is `PHASE4A4_1_PRODUCTION_CLEANUP_REPORT.md`, following the physical
comparison in `PHASE4A4_PHYSICAL_COMPARISON_REPORT.md`. Earlier reports document how the corpus
progressed through normalization, public-domain mining, clock-face eligibility, and sparse-tail
recovery.
